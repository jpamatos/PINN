...
from configs import BurgersDataConfig, BurgersPINNConfig, Config
...
cs.store(group="data", name="burgers_data", node=BurgersDataConfig)
cs.store(group="model", name="burgers_pinn", node=BurgersPINNConfig)
